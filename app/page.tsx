...
export default function Page() {
  const [state, setState] = useState<PaginationState>(DEFAULT_PAGINATION_STATE);
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Pagination Studio" controls={controls} preview={output} /></AppShell>;
}
