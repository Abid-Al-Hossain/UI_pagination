...
export default function TypographySection({ state, update }: Props) {
  return <SectionCard title="Typography" subtitle="Typography controls for native pagination generation."><FontFamilySelect value={state.fontFamily} onChange={(value) => update("fontFamily", value)} />
